...
/*   Updated: 2024/10/29 02:26:00 by lraggio          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	/*if (pthread_create(&observer_thread, NULL, (void *(*)(void *))observer, &table) != 0)
			return (perror("Erro ao criar a thread do observador"), ERROR);
